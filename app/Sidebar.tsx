...
export default function Sidebar() {
  ...
  return (
    <div className="bg-white flex-col w-fit ml-2 mt-16 shadow-2xl h-fit">
      <ul className="bg-white">
        {options.map((option, index) => (
          <li key={index} className="flex items-center mt-3 gap-4 hover:w-full hover:rounded-md hover:bg-gray-200">
            <Link href={option.value}>
              <button className="text-gray-600  p-3 flex items-center text-lg hover:text-color hover:bg-gray-200  mt-3">
      ...
      <div className="bg-gray-100 w-fit mt-5">
        <h1 className="text-gray-700 mb-3 p-2">Follow us on social media</h1>
        <div className="flex">
